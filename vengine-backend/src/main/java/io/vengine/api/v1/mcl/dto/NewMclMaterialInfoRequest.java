...
@Getter
@Setter
public class NewMclMaterialInfoRequest {
    ...
    private MclMaterialInfoRequestDto.DependencyInfoRequest colorDependency;
    private MclMaterialInfoRequestDto.DependencyInfoRequest sizeDependency;
    private MclMaterialInfoRequestDto.DependencyInfoRequest marketDependency;
}
