...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "supplier_adhoc_po_checking")
@AuditOverride(forClass = CommonDateEntity.class)
//@Audited
public class SupplierAdhocPoChecking extends CommonDateEntity {
    @Id
    ...
    @JoinColumn(name = "mcl_material_adhoc_purchase_order_publish_id", referencedColumnName = "id", nullable = false)
